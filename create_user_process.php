...
if($val["lid"] != ""){
    //user作成失敗
    exit("同一のユーザーidが存在しています。他のidで作成してください。");
}
//========================================================================================
...
//prepareで文字列として準備
$stmt = $pdo->prepare("INSERT INTO user_table(user_id,user_name,lid,lpw,user_address,kanri_flg,life_flg)VALUES(NULL,:a1,:a2,:a3,:a4,0,0)");
